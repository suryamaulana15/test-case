...
const Update = props => {
  ...
  const {account, page, onUpdate} = props;
  ...
  const onSubmit = data => {
    onUpdate(account.id, data, page, account.formSearch);
    // console.log(account.id, data, page, account.formSearch)
  }
  return (
    <Fragment>
...
const mapDispatchToProps = dispatch => {
  return {
    onUpdate: (id, storeData, page, formSearch) => dispatch(actions.updateAccount(id, storeData, page, formSearch))
  }
}
