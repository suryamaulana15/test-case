...
const Detail = props => {
              ...
              <CardContent>
                <div className={classes.contentPaddingBottom}>
                  <CardMedia
                    ...
                    image={'https://s1.bukalapak.com/img/1073070803/s-330-330/KEMEJA_EIGER_3250_STRUIK_1989___BAJU_LAPANGAN_EIGER.jpg.webp'}
                  />
                </div>
                <div className={clsx(classes.contentPaddingBottom, classes.contentCenter)}>
                  <Typography variant="h4" component="h2">
                    Nama Varian: {varian.nama}
                  </Typography>
                  <Typography variant="h5">
                    Harga: {varian.harga}
                  </Typography>
                  <Typography variant="h5">
                    Diskon: {varian.diskon.persentasi} %
                  </Typography>
                </div>
                <div>
  ...
  const addVariant = () => {
    ...
    setForm(<AddVariantTable id_produk={detail_product.id}/>)
  }
  ...
  const updateVariant = (varian) => {
    ...
    setForm(<UpdateVariantTable varian={varian}/>);
  }
  ...
  const updateProduct = (produk) => {
    ...
    setForm(<UpdateProduct produk={produk}/>);
  }
